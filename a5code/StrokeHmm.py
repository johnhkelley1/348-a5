...
class HMM:
    ...
    def viterbi(self,o_space, s_space, i_probs, obs, tran, emm):
        ...
        for i in range(1,T):
            ...
            for state in s_space:
                my_max = self.getMax(i,state,t1,tran,emm,obs)
                print j," ",i
                t1[j].append(my_max[1])
    ...
    def label( self, data ):
        ...
        o_space = [0,1] #0 = short, 1 = long
        s_space = ['text','drawing']
        i_probs = self.priors
